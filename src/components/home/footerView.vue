<template>
    <footer>
      ...
      <div class="details-center-footer">Thanh Toán</div>
      <div class="details-right-footer">Liên hệ chúng tôi tại: <br>
  ...
  .details-left-footer ul {
    list-style: none;
    padding: 20px;
  }
  
  .details-left-footer ul li {
    padding: 5px;
    font-size: 13px;
  ...
  .social-buttons {
    display: flex;
    box-shadow: 0px 0px 0px #00000027;
    padding: 15px 10px;
    border-radius: 5em;
  }
